...
func TestSerializeSchema(t *testing.T) {
	...
	tests := []struct {
		...
		{"default-vector", args{NewSchema(DefaultOptions).AddField(NewVectorFieldOptions("vec", VectorFieldOptions{Algorithm: Flat, Attributes: map[string]interface{}{"TYPE": "FLOAT32", "DIM": 128, "DISTANCE_METRIC": "L2"}})), redis.Args{}}, redis.Args{"SCHEMA", "vec", "VECTOR", Flat, 6, "TYPE", "FLOAT32", "DIM", 128, "DISTANCE_METRIC", "L2"}, false},
