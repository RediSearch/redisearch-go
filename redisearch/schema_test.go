...
func TestSerializeSchema(t *testing.T) {
	...
	tests := []struct {
		...
		{"default-and-tag-with-options_2", args{NewSchema(DefaultOptions).AddField(NewTagFieldOptions("tag-field", TagFieldOptions{Separator: byte(','), CaseSensitive: true, As: "field"})), redis.Args{}}, redis.Args{"SCHEMA", "tag-field", "AS", "field", "TAG", "SEPARATOR", ",", "CASESENSITIVE"}, false},
		{"default-and-tag-with-options_3", args{NewSchema(DefaultOptions).AddField(NewTagFieldOptions("tag-field", TagFieldOptions{Sortable: true, NoIndex: true, Separator: byte(','), As: "field"})), redis.Args{}}, redis.Args{"SCHEMA", "tag-field", "AS", "field", "TAG", "SEPARATOR", ",", "SORTABLE", "NOINDEX"}, false},
